from .member import Member, Name, Tags, StringCase

# includes graduated members
ALL_MEMBERS = [
    Member( 0, Name("ポカ", "Poka"), Tags("#pokablog")),
    Member( 1, Name("井口 眞緒", "Mao Iguchi"), Tags("#maoblog", "#maotalk")),
    Member( 2, Name("潮 紗理菜", "Sarina Ushio"), Tags("#sarinablog", "#sarinatalk", "#sarina8gram")),
    Member( 3, Name("柿崎 芽実", "Memi Kakizaki"), Tags("#memiblog", "#memitalk")),
    Member( 4, Name("影山 優佳", "Yuka Kageyama"), Tags("#kageblog", "#kagetalk", "#kagegram")),
    Member( 5, Name("加藤 史帆", "Shiho Kato"), Tags("#shihoblog", "#shihotalk", "#shihogram")),
    Member( 6, Name("齊藤 京子", "Kyoko Saito"), Tags("#Kyonkoblog", "#Kyonkotalk", "#Kyonkogram")),
    Member( 7, Name("佐々木 久美", "Kumi Sasaki"), Tags("#kumiblog", "#kumitalk", "#kumigram")),
    Member( 8, Name("佐々木 美玲", "Mirei Sasaki"), Tags("#mireiblog", "#mireitalk", "#panchangram")),
    Member( 9, Name("高瀬 愛奈", "Mana Takase"), Tags("#manablog", "#manatalk")),
    Member(10, Name("高本 彩花", "Ayaka Takamoto"), Tags("#ayakablog", "#ayakatalk", "#ayacherigram")),
    Member(11, Name("東村 芽依", "Mei Higashimura"), Tags("#meiblog", "#meitalk", "#meigram")),
    Member(12, Name("金村 美玖", "Miku Kanemura"), Tags("#mikublog", "#mikutalk", "#mikugram")),
    Member(13, Name("河田 陽菜", "Hina Kawata"), Tags("#hinablog", "#hinatalk", "#hina17gram")),
    ...
    Member(22, Name("髙橋 未来虹", "Mikuni Takahashi"), Tags("#mikuniblog", "#mikunitalk", "#mikunigram")),
    Member(23, Name("森本 茉莉", "Marie Morimoto"), Tags("#marieblog", "#marietalk", "#mariegram")),
    Member(24, Name("山口 陽世", "Haruyo Yamaguchi"), Tags("#haruyoblog", "#haruyotalk")),
